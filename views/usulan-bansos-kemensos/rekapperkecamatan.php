    ...
    ['class' => 'kartik\grid\SerialColumn'],
           [
            ...
            [
              'label'=>'jumlah',
              'attribute'=>'jmltotal',
              'pageSummary' => Html::a('<font color="red"><b>'.UsulanBansosKemensos::find()->count().'</b></font>', ['usulan-bansos-kemensos/rekapdata'] , []),
              'pageSummaryOptions' => ['class' =>'text-red'],
              'format' => 'html',
              'value' => function ($model) {
                            $hasil=Html::a('<font color="red"><b>'.$model['jmltotal'].'</b></font>', ['usulan-bansos-kemensos/rekapdata','kode_kecamatan'=>$model['kode_kecamatan']] , []);
                            return $hasil;
                           // return $model['jumlah'];
                         },
            ],
