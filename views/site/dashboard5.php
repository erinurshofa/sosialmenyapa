...
<head>
    ...
    <!-- <script src="https://unpkg.com/leaflet@1.9.3/dist/leaflet.js"></script> -->
     <!-- Load Leaflet.js from the Yii2 custom directory -->
...
<script>
    // // Initialize map
    // var map = L.map('map').setView([-6.9932, 110.4203], 12);
    // Initialize map
// var map = L.map('map').setView([-6.9861376, 110.4150528], 12); // Menurunkan latitude sedikit
...
// Add title next to zoom control
var title = L.control({ position: 'bottomleft' });

title.onAdd = function(map) {
    this._div = L.DomUtil.create('div', 'judulinfo');
    this._div.innerHTML = '<h4>Dashboard</h4>';
    // this._div.style.marginLeft = '20px';  // Adjust space between title and zoom control
    return this._div;
};
...
title.addTo(map);
    ...
    // Fetch GeoJSON data from external URL
    fetch('http://localhost/sosialmenyapa/web/geo/batas-kecamatan.geojson')
