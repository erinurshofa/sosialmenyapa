...
<table cellpadding="2" cellspacing="0" width="100%">
    <tr><td colspan='4'><strong>INFO LOKASI</strong></td></tr>
    <tr><td>NO IDP3KE</td><td>:</td><td><?=$keluarga->idp3ke?></td><td rowspan='8' style="text-align: right;"><img src="data:image/jpeg;base64,<?= $imageBase64 ?>" alt="Foto Rumah" width="113.385" height="170.118" /></td></tr>
    <tr><td>KEPALA KELUARGA</td><td>:</td><td><?=$keluarga->kepala_keluarga?></td></tr>
    <tr><td>KECAMATAN</td><td>:</td><td><?=$keluarga->kecamatan?></td></tr>
    <tr><td>KELURAHAN</td><td>:</td><td><?=$keluarga->kelurahan?></td></tr>
    <tr><td>ALAMAT</td><td></td><td><?=$keluarga->alamat?></td></tr>
    <tr><td>STATUS KEMISKINAN</td><td>:</td><td><?=strtoupper($keluarga->status_kemiskinan)?></td></tr>
    <tr><td>TOTAL PER HARI</td><td>:</td><td><?=formatRupiah($keluarga->total_per_hari)?></td></tr>
    <tr><td></td><td></td><td></td></tr>
</table>
<table cellpadding="2" cellspacing="0">
    <tr>
        <td colspan='6'><strong>KONDISI INDIKATOR RUMAH</strong></td>
    </tr>
    <tr>
        <td>Total Pendapatan Keluarga Sebulan</td><td>:</td><td><?=formatRupiah($keluarga->total_pendapatan_keluarga_sebulan)?></td>
        <td>Status Kepemilikan Rumah</td><td>:</td><td><?=$keluarga->kepemilikan_rumah?></td>
    </tr>
    <tr>
        <td>Dinding Rumah</td><td>:</td><td><?=$keluarga->jenis_dinding?></td>
        <td>Atap Rumah</td><td>:</td><td><?=$keluarga->jenis_atap?></td>
    </tr>
    <tr>
        <td>Lantai Rumah</td><td>:</td><td><?=$keluarga->jenis_lantai?></td>
        <td>Bahan Bakar Memasak</td><td>:</td><td><?=$keluarga->bahan_bakar_memasak?></td>  
    </tr>
    <tr>
        <td>Sumber Air Bersih</td><td>:</td><td><?=$keluarga->sumber_air_minum?></td>
        <td>Sumber Listrik Rumah</td><td>:</td><td><?=$keluarga->sumber_penerangan?></td>
    </tr>
    <tr>
        <td>Fasilitas Buang Air Besar</td><td>:</td><td><?=$keluarga->memiliki_fasilitas_buang_air_besar?></td>
    </tr>
</table>
<br>
...
foreach ($individu as $key => $value) { 
    $t=ActionsHelper2023::getKebutuhan($value->idp3ke,$value->id);
    $data='';
...
<table width="100%">
    <tr>
        <td></td><td></td><td style="text-align:right">Tanggal <?=date('d-m-Y')?></td>
    </tr>
    <tr>
        <td></td><td></td><td style="text-align:right">Kepala Dinas</td>
    </tr>
    <tr>
        <td></td><td></td><td></td>
    </tr>
