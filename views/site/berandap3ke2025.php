...
if((in_array(strtolower(Yii::$app->user->identity->role), $roleadmin))){
  ...
  $jml_kemiskinan_ekstrem_keluarga=@P3keKeluarga2025::find()->where(['status_kemiskinan'=>'Kemiskinan Ekstrem'])->andWhere(['status_keberadaan'=>'Ditemukan'])->andWhere(['status_intervensi'=>'Belum'])->orWhere(['status_intervensi'=>'Sedang Proses'])->count();
  $jml_kemiskinan_ekstrem_individu=@P3keIndividu2025::find()->where(['status_kemiskinan'=>'Kemiskinan Ekstrem'])->andWhere(['status_keberadaan'=>'Ditemukan'])->andWhere(['status_intervensi'=>'Belum'])->orWhere(['status_intervensi'=>'Sedang Proses'])->count();
  $jml_ke_keluarga=@P3keKeluarga2025::find()->where(['status_kemiskinan'=>'Kemiskinan Ekstrem'])->andWhere(['status_keberadaan'=>'Ditemukan'])->count();
  $jml_ke_individu=@P3keIndividu2025::find()->where(['status_kemiskinan'=>'Kemiskinan Ekstrem'])->andWhere(['status_keberadaan'=>'Ditemukan'])->count();
...
if(@Yii::$app->user->identity->role=='kecamatan'){
  ...
  $jml_verifikasi_keluarga=@P3keKeluarga2025::find()->where(['status_verval'=>'Sudah'])->andWhere(['kecamatan'=>@$kecamatan])->count();
  $jml_verifikasi_individu=@P3keIndividu2025::find()->where(['verifikasi'=>'Sudah'])->andWhere(['kecamatan'=>@$kecamatan])->count();
  $jml_ditemukan_individu=@P3keIndividu2025::find()->where(['status_keberadaan'=>'Ditemukan'])->andWhere(['kecamatan'=>@$kecamatan])->count();
  $jml_meninggal_individu=@P3keIndividu2025::find()->where(['status_keberadaan'=>'Meninggal'])->andWhere(['kecamatan'=>@$kecamatan])->count();
  $j_total_keluarga=@P3keKeluarga2025::find()->where(['kecamatan'=>@$kecamatan])->count();
  $j_total_individu=@P3keIndividu2025::find()->where(['kecamatan'=>@$kecamatan])->count();
  $jml_kemiskinan_ekstrem_keluarga=@P3keKeluarga2025::find()->where(['status_kemiskinan'=>'Kemiskinan Ekstrem'])->andWhere(['status_keberadaan'=>'Ditemukan'])->andWhere(['status_intervensi'=>'Belum'])->orWhere(['status_intervensi'=>'Sedang Proses'])->andWhere(['kecamatan'=>@$kecamatan])->count();
  $jml_kemiskinan_ekstrem_individu=@P3keIndividu2025::find()->where(['status_kemiskinan'=>'Kemiskinan Ekstrem'])->andWhere(['status_keberadaan'=>'Ditemukan'])->andWhere(['status_intervensi'=>'Belum'])->orWhere(['status_intervensi'=>'Sedang Proses'])->andWhere(['kecamatan'=>@$kecamatan])->count();
  $url_ke_keluarga=Url::to(['p3ke2025/index','status_kemiskinan_keluarga'=>'Kemiskinan Ekstrem','status_keberadaan_keluarga'=>'Ditemukan','status_intervensi_keluarga'=>'Belum dan Sedang Proses','kecamatan'=>@$kecamatan,'set'=>'tab1']);
  $url_ke_individu=Url::to(['p3ke2025/index','status_kemiskinan_individu'=>'Kemiskinan Ekstrem','status_keberadaan_individu'=>'Ditemukan','status_intervensi_individu'=>'Belum dan Sedang Proses','kecamatan'=>@$kecamatan,'set'=>'tab2']);
}
if(@Yii::$app->user->identity->role=='kelurahan'){
  ...
  $jml_verifikasi_keluarga=@P3keKeluarga2025::find()->where(['status_verval'=>'Sudah'])->andWhere(['kecamatan'=>@$kecamatan])->andWhere(['kelurahan'=>@$kelurahan])->count();
  $jml_verifikasi_individu=@P3keIndividu2025::find()->where(['verifikasi'=>'Sudah'])->andWhere(['kecamatan'=>@$kecamatan])->andWhere(['kelurahan'=>@$kelurahan])->count();
  $jml_ditemukan_individu=@P3keIndividu2025::find()->where(['status_keberadaan'=>'Ditemukan'])->andWhere(['kecamatan'=>@$kecamatan])->andWhere(['kelurahan'=>@$kelurahan])->count();
  $jml_meninggal_individu=@P3keIndividu2025::find()->where(['status_keberadaan'=>'Meninggal'])->andWhere(['kecamatan'=>@$kecamatan])->andWhere(['kelurahan'=>@$kelurahan])->count();
  $j_total_keluarga=@P3keKeluarga2025::find()->where(['kecamatan'=>@$kecamatan])->andWhere(['kelurahan'=>@$kelurahan])->count();
  $j_total_individu=@P3keIndividu2025::find()->where(['kecamatan'=>@$kecamatan])->andWhere(['kelurahan'=>@$kelurahan])->count();
  $jml_kemiskinan_ekstrem_keluarga=@P3keKeluarga2025::find()->where(['status_kemiskinan'=>'Kemiskinan Ekstrem'])->andWhere(['status_keberadaan'=>'Ditemukan'])->andWhere(['status_intervensi'=>'Belum'])->orWhere(['status_intervensi'=>'Sedang Proses'])->andWhere(['kecamatan'=>@$kecamatan])->andWhere(['kelurahan'=>@$kelurahan])->count();
  $jml_kemiskinan_ekstrem_individu=@P3keIndividu2025::find()->where(['status_kemiskinan'=>'Kemiskinan Ekstrem'])->andWhere(['status_keberadaan'=>'Ditemukan'])->andWhere(['status_intervensi'=>'Belum'])->orWhere(['status_intervensi'=>'Sedang Proses'])->andWhere(['kecamatan'=>@$kecamatan])->andWhere(['kelurahan'=>@$kelurahan])->count();
  $url_ke_keluarga=Url::to(['p3ke2025/index','status_kemiskinan_keluarga'=>'Kemiskinan Ekstrem','status_keberadaan_keluarga'=>'Ditemukan','status_intervensi_keluarga'=>'Belum dan Sedang Proses','kecamatan'=>@$kecamatan,'kelurahan'=>@$kelurahan,'set'=>'tab1']);
  $url_ke_individu=Url::to(['p3ke2025/index','status_kemiskinan_individu'=>'Kemiskinan Ekstrem','status_keberadaan_individu'=>'Ditemukan','status_intervensi_individu'=>'Belum dan Sedang Proses','kecamatan'=>@$kecamatan,'kelurahan'=>@$kelurahan,'set'=>'tab2']);
}
...
<?php
  ...
  text-align: center;cursor: pointer;">
                ...
                <a href="<?=Url::to(['p3ke2025/index','verifikasi_keluarga'=>'Sudah','set'=>'tab1'])?>" class="small-box-footer" style="border-bottom-right-radius: 25px;border-bottom-left-radius: 25px;border-bottom:15px solid red;color:navy;">
  ...
  text-align: center;cursor: pointer;">
            ...
            <a href="<?=Url::to(['p3ke2025/index','verifikasi_individu'=>'Sudah','set'=>'tab2'])?>" class="small-box-footer" style="border-bottom-right-radius: 25px;border-bottom-left-radius: 25px;border-bottom:15px solid red;color:navy;">
  ...
  text-align: center;cursor: pointer;">
            ...
            <a href="<?=Url::to(['p3ke2025/index','status_keberadaan_individu'=>'Ditemukan','set'=>'tab2'])?>" class="small-box-footer" style="border-bottom-right-radius: 25px;border-bottom-left-radius: 25px;border-bottom:15px solid red;color:navy;">
  ...
  text-align: center;cursor: pointer;">
            ...
            <a href="<?=Url::to(['p3ke2025/index','status_keberadaan_individu'=>'Meninggal','set'=>'tab2'])?>" class="small-box-footer" style="border-bottom-right-radius: 25px;border-bottom-left-radius: 25px;border-bottom:15px solid red;color:navy;">
      ...
      <div class="row">
            <div class="col-md-12">
              <div class="box box-navy box-solid" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    ...
                    <div class="box-body">
                        <p>(Sumber Data dari P3KE Kota Semarang Tahun 2024 (Desil 1, Persentil 1, Pemukhtahiran Tahun 2022 & 2023)</p>
                    </div>
                </div>
            </div>
        </div>
