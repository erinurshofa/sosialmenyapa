          ...
          <div class="nav-tabs-custom box box-success box-solid">
            ...
            <div class="tab-content">
              <div class="tab-pane" id="tab_1-1">
                 <?= $this->render('presentase/presentase_program_bantuan_oktober_2020', [
				        'program_bantuan' => $program_bantuan,
				    ]) ?>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="tab_2-2">
                 <?= $this->render('grafik/grafik_program_bantuan_oktober_2020', [
			        'program_bantuan' => $program_bantuan,
			    ]) ?>
              </div>
              <!-- /.tab-pane -->
...
$gridColumns = [
    ['class' => 'kartik\grid\SerialColumn'],
            ...
            [
              ...
              'hAlign' => 'right',
              'pageSummary' => true,
              'pageSummary' => Html::a('<font color="blue"><b>'.Bdtart::find()->where("Ada_kks = 'Ya'")->count().'</b></font>', ['bdtart/listbdtart', ['program_bantuan'=>'statuskks',]] ),
              'format' => 'html',
              'value' => function ($model) {
                            $hasil=Html::a('<font color="orange"><b>'.$model['statuskks'].'</b></font>', ['bdtart/listbdtart',['program_bantuan'=>'statuskks','kodekecamatan'=>$model['KDKEC']]] , []);
                            return $hasil;
             ...
             [
              ...
              'hAlign' => 'right',
              'pageSummary' => true,
              'pageSummary' => Html::a('<font color="blue"><b>'.Bdtart::find()->where("Ada_pbi = 'Ya'")->count().'</b></font>', ['bdtart/listbdtart', ['program_bantuan'=>'statuspbi',]] ),
              'format' => 'raw',
              'value' => function ($model) {
                           $hasil=Html::a('<font color="orange"><b>'.$model['statuspbi'].'</b></font>', ['bdtart/listbdtart',['program_bantuan'=>'statuspbi','kodekecamatan'=>$model['KDKEC']]] , []);
                            return $hasil;
                         },
            ],
            [
              ...
              'format'=>'decimal',
              'pageSummary' => true,
              'pageSummary' => Html::a('<font color="blue"><b>'.Bdtart::find()->where("Ada_kip = 'Ya'")->count().'</b></font>', ['bdtart/listbdtart', ['program_bantuan'=>'statuskip',]] ),
              'format' => 'html',
              'value' => function ($model) {
                           $hasil=Html::a('<font color="orange"><b>'.$model['statuskip'].'</b></font>', ['bdtart/listbdtart',['program_bantuan'=>'statuskip','kodekecamatan'=>$model['KDKEC']]] , []);
                            return $hasil;
            ...
            [
              ...
              'hAlign' => 'right',
              'pageSummary' => true,
              'pageSummary' => Html::a('<font color="blue"><b>'.PkhJanuari2021::find()->count().'</b></font>', ['pkh-januari2021/index', ['program_bantuan'=>'statuspkh',]] ),
              'format' => 'html',
              'value' => function ($model) {
                           $hasil=Html::a('<font color="orange"><b>'.$model['statuspkh'].'</b></font>', ['pkh-januari2021/index',['program_bantuan'=>'statuspkh','kodekecamatan'=>$model['KDKEC']]] , []);
                            return $hasil;
                         },
            ],
            [
              ...
              'hAlign' => 'right',
              'pageSummary' => true,
              'pageSummary' => Html::a('<font color="blue"><b>'.BspJanuari2021::find()->count().'</b></font>', ['bdtart/listbdtart', ['program_bantuan'=>'statusbsp',]] ),
              'format' => 'html',
              'value' => function ($model) {
                           $hasil=Html::a('<font color="orange"><b>'.$model['statusbsp'].'</b></font>', ['bsp-januari2021/index',['program_bantuan'=>'statusbsp','kodekecamatan'=>$model['KDKEC']]] , []);
                            return $hasil; 
            ...
            //   'hAlign' => 'right',
            //   'pageSummary' => true,
            //   'pageSummary' => Html::a('<font color="blue"><b>'.Bdtart::find()->where("sta_asuransi = 'Ya'")->count().'</b></font>', ['bdtrt/listbdtrt', ['program_bantuan'=>'statusasuransi',]] ),
            //   'format' => 'html',
            //   'value' => function ($model) {
