...
$no=1;
    foreach($jenis_kelamin['jenis_kelamin'] as $key=>$values){
            $pria=(int)$values['pria'];
            $perempuan=(int)$values['perempuan'];
            $jenis_kelamin[$key]['total']=$pria+$perempuan;
         $highchartpria[]= array(
                'type'=> 'column', 
...
echo Highcharts::widget([
 ...
 'yAxis' => [
    'title' => ['text' => $jenis_kelamin['yaxis']],
 ],
 'legend'=> [
        'layout'=> 'vertical',
        'align'=>'right',
