...
$this->title = 'Data Santunan Disabilitas';
$this->params['breadcrumbs'][] = ['label' => 'Santunan Disabilitas', 'url' => ['listdata']];
...
$action=[
  ...
  'value' => function ($model) {
    ...
    //   </div>';               
    //   return '<div class="btn-group">
    //       '.Html::a('<i class="fas fa-fw fa-search"></i>View', ['SantunanDisabilitas/view', 'id' => $model->id], ['class' => 'btn btn-success btn-xs']).'
    //       '.Html::a('<i class="fas fa-fw fa-check-square"></i>Detail', ['SantunanDisabilitas/detail', 'idp3ke' => $model->id], ['class' => 'btn btn-primary btn-xs']).'
    //       '.Html::a('<i class="fas fa-fw fa-file-pdf-o"></i>Pdf V2', ['SantunanDisabilitas/pdf-new', 'idp3ke' => $model->id], ['class' => 'btn btn-danger btn-xs','target' => '_blank']).'
    //     '.Html::a('<i class="fas fa-fw fa-edit"></i>Edit', ['SantunanDisabilitas/edit',  'id' => $model->id, 'kategori' => 'individu'], ['class' => 'btn btn-warning btn-xs']).'
    //   </div>';      
    return '<div class="btn-group">' .
            ...
            'value' => function ($model) {
                ...
                foreach ($dokumen as $field => $label) {
                    if (!empty($model->$field)) {
                        $url = Yii::getAlias('@web') . '/uploads/santunan_disabilitas/' . ltrim($model->$field, '/');
                        $links[] = Html::a(
                            '<span class="badge badge-info" style="font-size:12px;"><i class="fa fa-eye"></i> ' . $label . '</span>',
                            $url,
...
<div class="box box-navy box-solid" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    ...
    <?php $form = ActiveForm::begin([
            'method' => 'get',
            'action' => ['santunan-disabilitas/listdata'],
        ]); ?>
 <div class="row">
  <div class="col-md-2">       
    ...
    <?php
                        echo ExportMenu::widget([
                            ...
                            'columns' => $export,
                            'filename'=>'data_SantunanDisabilitas',
                        ]);?>
            ...
            <div class="col-md-3 text-right">
                ...
                <?= Html::a('Reset', ['santunan-disabilitas/listdata'], ['class' => 'btn btn-default']) ?>
            </div>
        </div>
