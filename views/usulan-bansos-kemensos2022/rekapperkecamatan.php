...
$this->title = 'Rekapitulasi Usulan Bansos Kemensos Per Kecamatan';
...
/* @var $this yii\web\View */
 ...
 $dataProvider = new ArrayDataProvider([
        'allModels' => @$usulan_bansos_kemensos['usulan_bansos_kemensos'],
    ]);
?>
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom box box-success box-solid">
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header text-blue"><i class="fa fa-book text-red"></i> Rekapitulasi Data Usulan Bansos Kemensos
    ...
    ['class' => 'kartik\grid\SerialColumn'],
           [
            ...
            [
              'label'=>'jumlah',
              'attribute'=>'jmltotal',
              'pageSummary' => Html::a('<font color="red"><b>'.UsulanBansosKemensos2022::find()->count().'</b></font>', ['usulan-bansos-kemensos2022/rekapdata'] , []),
              'pageSummaryOptions' => ['class' =>'text-red'],
              'format' => 'html',
              'value' => function ($model) {
                            $hasil=Html::a('<font color="red"><b>'.$model['jmltotal'].'</b></font>', ['usulan-bansos-kemensos2022/rekapdata','kode_kecamatan'=>$model['kode_kecamatan']] , []);
                            return $hasil;
                           // return $model['jumlah'];
                         },
            ],
