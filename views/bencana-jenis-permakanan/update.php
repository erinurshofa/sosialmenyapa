...
$this->title = 'Update Bencana Jenis Permakanan: ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Bencana Jenis Permakanans', 'url' => ['index']];
...
<div class="box box-navy box-solid mt-2" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    ...
    <div class="box-body p-2">
        <div class="bencana-jenis-permakanan-update">
