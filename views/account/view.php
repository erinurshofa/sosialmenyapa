        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              ...
              <h5 class="widget-user-desc"><?=strtoupper($model->jabatan)?></h5>
            </div>
              ...
              <ul class="nav nav-pills nav-stacked">
                <li class="active">
                  <a href="#"><i class="fa fa-th"></i> BDTART
                    <span class="label label-primary pull-right"><?=Bdtart::find()->count()?></span>
                  </a></li>
                <li><a href="#"><i class="fa fa-th"></i> BDTRT<span class="label label-warning pull-right"><?=Bdtrt::find()->count()?></span></a></li>
                <li><a href="#"><i class="fa fa-th"></i> USER<span class="label label-danger pull-right"><?=Account::find()->count()?></span></a></li>
        ...
        'attributes' => [
            ...
            [
              ...
              'attribute'=>function($model){
                  return @ActSecure::decryptPassword($model->password);
              }
          ],
            'nip',
            'nama_lengkap',
