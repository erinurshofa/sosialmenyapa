...
?>
           <div class="row">
               ...
               $kecamatan17=$jenis_kelamin['jenis_kelamin'][16]['pria'];
...
echo Highcharts::widget([
    'options' => [
        'title' => ['text' => 'Presentase Laki-Laki Per Kecamatan Sekota Semarang'],
        'styledMode'=> true,
        'plotOptions' => [
            'pie' => [
                'cursor' => 'pointer',
        ...
        'series' => [
            [ // new opening bracket
                ...
                'data' => [
                    ...
                    [$jenis_kelamin['jenis_kelamin'][16]['kecamatan'], round($persen17,1),false],
                ],
                'showInLegend'=> true,
                "dataLabels" => [
                    "enabled"=> true,
              ...
              <?php
               ...
               $kecamatan17=$jenis_kelamin['jenis_kelamin'][16]['perempuan'];
               $total=$kecamatan1+$kecamatan2+$kecamatan3+$kecamatan4+$kecamatan5+$kecamatan6+$kecamatan7+$kecamatan8+$kecamatan9+$kecamatan10+$kecamatan11+$kecamatan12+$kecamatan13+$kecamatan14+$kecamatan15+$kecamatan16+$kecamatan17;
               $persen1=($kecamatan1/$total)*100;
               $persen2=($kecamatan2/$total)*100;
               $persen3=($kecamatan3/$total)*100;
...
echo Highcharts::widget([
    'options' => [
        'title' => ['text' => 'Presentase Perempuan Per Kecamatan Sekota Semarang'],
        'plotOptions' => [
            'pie' => [
                'cursor' => 'pointer',
            ],
