...
$this->title = 'CEK NO KK BERDASARKAN DATA PERIODE OKTOBER 2020';
$statusdtks=false;
  ...
  <div class="col-md-6">
    <div class="box box-danger box-solid" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
        <div class="box-header bg-danger">
            <strong><?= Html::encode('CEK NO KK BERDASARKAN DATA PERIODE OKTOBER 2020') ?></strong>
        </div>
        <div class="box-body">
            ...
            <div class="box-body responsive">
                  <table class="table table-hover">
                   ...
                   $tampil=''; 
                    ...
                    //         $tampil.='<tr><td><strong style="color:red;">BPNT</td><td>:</td><td>'.@$model->NoPesertaKKS2016.'</strong><span class="pull-right-container">
                    ...
                    //     }else{
                    //         //ada nomor dan status ya+
                    //         $tampil.='<tr><td>BPNT</td><td>:</td><td>'.$model->NoPesertaKKS2016.'</td><tr>';
                    //         $nomorbpnt=1;
                    //     }
                    // }
...
<?php  } ?>
  ...
  <div class="col-md-6">
  <?php if (!empty($datadukcapil)) {$statusdukcapil=true; ?>
    <div class="box box-success box-solid">
        ...
        ?>    
            <?php
                $datakepalakeluarga=@$datadukcapil[0];
                if (is_array($datakepalakeluarga)) {
            
                    echo "<table class='table table-hover'>";
                        foreach ($datakepalakeluarga as $nama_index=>$isi) {
                            $array_search = array('','NIK','NO_KK','NAMA_LGKP','TMPT_LHR','TGL_LHR','ALAMAT','NO_RT','NO_RW');
                    ...
                    echo "<table class='table table-hover'>";
                        foreach ($data as $nama_index=>$isi) {
                            switch ($nama_index) {
                                ...
                                //         $isi="tidak terdaftar";
                                //     }
                                //     echo "<td> Bansos Sembako APBD Tahap 1 Kota Semarang </td> <td> : </td> <td> $isi </td>";
                                //     echo "</tr>";
                                //     break;
                                ...
                                //         $isi="tidak terdaftar";
                                //     }
                                //     echo "<td> Bansos Sembako APBD Tahap 2 Kota Semarang </td> <td> : </td> <td> $isi </td>";
                                //     echo "</tr>";
                                //     break;
                                ...
                                //         $isi="tidak terdaftar";
                                //     }
                                //     echo "<td> Bansos Sembako Tahap 3 Kota Semarang </td> <td> : </td> <td> $isi </td>";
                                //     echo "</tr>";
                                //     break;
...
<table class="table table-hover">
                  ...
                  <?php
                    ...
                    foreach ($datadukcapil as $key => $value) {
                        ...
                        $tam .= '<tr>
                    <td>'.$num++.'</td>
                    <td>'.Html::a($value['NIK'], ['validasi/ceknik', 'nik' => $value['NIK']], ['class' => '']).'</td>
