...
$this->title = 'CEK IDBDT DATA PERIODE OKTOBER 2020';
$statusdtks=false;
...
<div class="row">
  ...
  text-align: center;">
        <div class="box-header bg-danger">
            <strong style="font-weight: bold;color:white;font-family:roboto;"><?= Html::encode('CEK IDBDT DATA PERIODE OKTOBER 2020') ?></strong>
        </div>
        <div class="box-body">
            <?= $this->render('_formidbdt', [
                'model' => $model,
                'bdtart' =>$bdtart,
        ...
        <div class="box-body">
            ...
            <?php }else{?>
                ...
                <tr>
                    <td>Status Dukcapil</td>
                    <td>:</td>
                    <td><strong><font color="red"> Pencarian NIK berdasarkan IDBDT tidak valid!</font></strong></td>
                </tr>
                <?php } ?>
            <?php } ?>
            <?php if (!empty($bdtart)) { ?>
