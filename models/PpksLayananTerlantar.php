...
/**
 * This is the model class for table "ppks_layanan_terlantar".
 *
 * @property int $id
 ...
 * @property Ppks $ppks
 * @property RefStatusTerlantar $status
 */
class PpksLayananTerlantar extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['ppks_id', 'layanan_id', 'status_id', 'tanggal_layanan'], 'required'],
            [['ppks_id', 'layanan_id', 'status_id'], 'integer'],
            ...
            [['status_id'], 'exist', 'skipOnError' => true, 'targetClass' => RefStatusTerlantar::class, 'targetAttribute' => ['status_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(RefStatusTerlantar::class, ['id' => 'status_id']);
    }
}
