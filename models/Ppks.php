...
class Ppks extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nik', 'nama','alamat_domisili', 'kecamatan_domisili_id', 'kelurahan_domisili_id'], 'required'],
            [['tanggal_lahir', 'tanggal_masuk_panti', 'tanggal_keluar_panti', 'created_at', 'updated_at', 'tanggal_verifikasi', 'tanggal_validasi', 'tanggal_approval', 'tanggal_input'], 'safe'],
            [['dsen_id', 'provinsi_id', 'kota_id', 'kecamatan_id', 'kelurahan_id', 'provinsi_domisili_id', 'kota_domisili_id', 'kecamatan_domisili_id', 'kelurahan_domisili_id', 'user_id', 'apakah_terlantar'], 'integer'],
            [['keterangan_verifikasi'], 'string'],
            [['nama', 'jenis_kelamin', 'provinsi_id', 'provinsi', 'kota_id', 'kota', 'kecamatan_id', 'kecamatan', 'kelurahan_id', 'kelurahan', 'provinsi_domisili_id', 'provinsi_domisili', 'kota_domisili_id', 'kota_domisili', 'kecamatan_domisili_id', 'kecamatan_domisili', 'kelurahan_domisili_id', 'kelurahan_domisili', 'jenis_ppks_fix', 'jenis_disabilitas', 'sumber_data', 'tempat_lahir', 'tanggal_lahir','tinggal_dalam_keluarga','hubungan_dgn_kepala_keluarga','status_kawin','pekerjaan_atau_sekolah','kondisi_keterlantaran','keterangan', 'punya_ktp', 'nama_cp', 'nomor_hp_cp', 'khusus_penyandang_disabilitas', 'tanggal_input', 'kondisi_kesehatan', 'keterangan_disabilitas_ganda', 'keterangan_di_luar_keluarga'], 'string', 'max' => 255],
