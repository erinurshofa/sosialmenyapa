...
/**
 * PsmSearch represents the model behind the search form of `app\models\Psm`.
 */
class PsmSearch extends Psm
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['nama', 'nik', 'email', 'hp', 'kecamatan', 'kelurahan', 'keterangan', 'tempat_lahir', 'tanggal_lahir', 'jalan', 'rt', 'rw', 'provinsi_id', 'kota_id', 'kecamatan_id', 'kelurahan_id', 'login_terakhir', 'no_rekening', 'nama_pemilik', 'nama_bank', 'no_sertifikat', 'tanggal_sertifikat', 'file_sertifikat', 'file_sk_walikota', 'created_at', 'updated_at'], 'safe'],
        ];
    }
